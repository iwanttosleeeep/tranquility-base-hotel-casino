...
export default function LibraryView() {
  ...
  return <div className="w-full max-w-6xl mx-auto flex flex-col gap-8">
    <div>
      ...
      <p className="text-sm md:text-lg text-[#f5f2ed]/70 font-serif max-w-3xl leading-relaxed">A source-led reading desk for the record’s songs. Every note below comes from the verified reference catalogue or the interview archive; the Library does not reproduce full lyrics.</p>
    </div>
