          ...
          <div className="flex flex-col gap-1.5 max-h-[400px] overflow-y-auto pr-2 custom-scrollbar">
            {SONGS_DATA.map((track, index) => {
              ...
              return (
                ...
                >
                  <span className="font-panel text-[11px] opacity-40">
        ...
        <div className="lg:col-span-5 flex flex-col gap-6">
          <div className="p-8 rounded-lg glass-panel border border-[#c5a059]/20 bg-[#120e0a]/40 relative flex flex-col min-h-[350px]">
            ...
            {isPlaceholder ? (
              ...
              >
                <span className="font-panel text-[11px] uppercase tracking-widest text-[#c5a059]/50 mb-2">
                ...
                {song.annotatedLines.map((annotated, idx) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <span className="font-panel text-[10px] uppercase tracking-widest text-right self-end opacity-60">
                        [ Read Annotation ]
                      </span>
                    </button>
                  );
              ...
              >
                ...
                {song.annotatedLines[selectedLineIndex].sourceUrl && (
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="font-panel text-[11px] uppercase text-[#d97706] hover:underline flex items-center gap-1 mt-1"
                  >
                ...
                {song.annotatedLines[selectedLineIndex].references &&
                  song.annotatedLines[selectedLineIndex].references!.length > 0 && (
                    <div className="flex flex-col gap-1">
                      <span className="font-panel text-[10px] uppercase tracking-widest text-[#d97706]/60">
                        Cross References
                      </span>
                      <div className="flex flex-wrap gap-1">
                        {song.annotatedLines[selectedLineIndex].references!.map((ref) => (
                          <span
                            key={ref}
                            className="font-panel text-[10px] bg-black/40 border border-[#d97706]/20 text-[#d97706] px-1.5 py-0.5 rounded"
                          >
                            {ref}
                          </span>
                        ))}
                ...
                <button
                  ...
                  className="font-panel text-[11px] uppercase text-[#d97706]/60 hover:text-[#d97706] text-left transition-colors"
                >
                  [ Close annotation ]
                </button>
              </motion.div>
                ...
                <div className="grid grid-cols-1 gap-4">
                  {song.filmReferences && song.filmReferences.length > 0 ? (
                    <div className="flex flex-col gap-1.5">
                      <span className="font-panel text-[10px] uppercase tracking-widest text-[#c5a059]/40">
                        Film References
                      </span>
