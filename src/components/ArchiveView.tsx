...
export default function ArchiveView() {
  ...
  return (
    <div className="w-full max-w-4xl mx-auto flex flex-col gap-8">
      ...
      {/* ─── Verified Reference Catalogue (relocated from Hotel Cinema) ─── */}
      <div className="border-t border-[#c5a059]/15 pt-8 flex flex-col gap-2">
        <span className="font-serif italic text-2xl text-glow text-[#f5f2ed]">Verified Reference Catalogue</span>
        <p className="font-serif text-xs text-[#f5f2ed]/50 max-w-2xl leading-relaxed">Source-linked records of the works documented around the album. Every entry carries an evidence grade; a grade is a statement about documentation, not a claim of influence beyond it.</p>
      </div>
