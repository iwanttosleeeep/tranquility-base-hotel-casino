        ...
        <section className="w-full rounded-xl glass-panel border border-[#c5a059]/20 bg-[#120e0a]/40 p-6 md:p-8 flex flex-col gap-7">
          ...
          <form onSubmit={verifyCode} className="flex flex-col gap-5">
            ...
            <input
              ...
              className="w-full max-w-[14rem] bg-black/35 border border-[#c5a059]/50 rounded-lg px-5 py-3.5 md:px-6 md:py-4 font-tbhc tracking-[0.3em] text-xl md:text-2xl text-[#f5f2ed] placeholder:text-[#f5f2ed]/25 focus:outline-none focus:border-[#c5a059]"
            />
            <div className="flex flex-col-reverse sm:flex-row sm:items-center sm:justify-between gap-4">
