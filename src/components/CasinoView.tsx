...
const REEL_ITEMS: ReelItem[] = [
  { id: "front-desk", icon: Bell, label: "Front Desk", bonus: "Mark is ready to direct your call.", frequency: 196, waveform: "sine" },
  ...
  ,{ id: "economic-review", icon: Landmark, label: "Economic Review", bonus: "The information-action ratio has been recalculated.", frequency: 246.94, waveform: "triangle" }
  ,{ id: "media-feed", icon: Newspaper, label: "Media Feed", bonus: "The headline has refreshed itself.", frequency: 369.99, waveform: "square" }
  ,{ id: "terminal", icon: Cpu, label: "Terminal", bonus: "Simulation parameters remain comfortably vague.", frequency: 293.66, waveform: "sawtooth" }
  ,{ id: "observatory", icon: Telescope, label: "Observatory", bonus: "A distant signal has been given a room number.", frequency: 174.61, waveform: "triangle" }
  ,{ id: "cinema", icon: Film, label: "Cinema", bonus: "The unseen documentary is now accepting reservations.", frequency: 392, waveform: "sine" }
  ,{ id: "library", icon: BookOpen, label: "Library", bonus: "A footnote has escaped its assigned chapter.", frequency: 233.08, waveform: "triangle" }
  ,{ id: "coordinates", icon: Hexagon, label: "Coordinates", bonus: "Coordinates locked on Tranquility Base.", frequency: 220, waveform: "triangle" }
];
